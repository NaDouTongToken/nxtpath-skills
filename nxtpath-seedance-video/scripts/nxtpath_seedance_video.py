...
DEFAULT_MODEL = "seedance/seedance-2.0"
...
def _family_label(model):
    return "seedance-2.5" if _is_seedance_25(model) else "seedance-2.0"
...
def _build_payload(model, prompt, duration, resolution, ratio, ref_images, ref_videos):
